    ...
    <div class="card-body row">
        ...
        <div class="col 6">
            ...
            <div class="row col-12">
                ...
                <h1 class="col-2 fw-bold text-center">Valor</h1>
                <h1 class="col-2 fw-bold text-center">Data de Vencimento</h1>
                <h1 class="col-1 fw-bold text-center">Status</h1>
                <h1 class="col-2 fw-bold text-center">Pagador</h1>
            </div>

            <g:each var="payment" in="${paymentList}">
                <ul class="list-group list-group-horizontal mb-1 mb-1 col">
                    <li class="custom-list-item col-3">${payment.billingType}</li>
                    <li class="custom-list-item col-2">${payment.value}</li>
                    <li class="custom-list-item col-2">${payment.dueDate}</li>
                    <li class="custom-list-item col-1">${payment.status}</li>
                    <li class="custom-list-item col-2">${payment.payer.name}</li>

                    <ul class="col list-group list-group-horizontal justify-content-end">

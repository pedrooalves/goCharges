    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-weight-bold">Confirmar remoção de pagador</h2>
            </div>

            <div class="modal-body">
                <h2 class="text-center">Deseja confirmar a remoção deste pagador?</h2>
            </div>
            ...
            <div class="modal-footer">
                ...
                <g:form url="[controller: 'payer', action: 'delete']" method="PUT">
